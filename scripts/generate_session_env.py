"""
Kakao Session Generator for Cloud / Render Deployment.
Runs Playwright on local Mac (Korean Residential IP), completes Kakao login,
and extracts the full cookies & storageState into a single-line string ready for SESSION_STORAGE_STATE.
"""
...
[Render 등록 가이드]")
    ...
    print("=" * 65)
    print("
--- [SESSION_STORAGE_STATE 값 시작] ---
")
    print(session_str)
    print("
--- [SESSION_STORAGE_STATE 값 끝] ---
")
